...
def test_websocket_session_flow(openai_realtime_client):
    ...
    # Step 5: Send input_audio_buffer.commit event and wait for input_audio_buffer.committed, 
    # conversation.item.created, conversation.item.input_audio_transcription.delta ,conversation.item.input_audio_transcription.completed
